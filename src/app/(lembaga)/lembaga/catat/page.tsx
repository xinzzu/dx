...
export default function CatatLembagaPage() {
      ...
      <div className="mx-auto max-w-lg px-4 pb-[88px] pt-6">
        ...
        <section className="mt-5">
          ...
          <div className="space-y-3">
            <CategoryItem
              ...
              href="/lembaga/catat/transportasi"
            />
            <CategoryItem
              iconSrc="/images/catat/energy.png"
              title="Penggunaan Listrik"
              subtitle="Konsumsi energi listrik"
              href="/lembaga/catat/energi-listrik"
            />
            <CategoryItem
              iconSrc="/trash.png"
              title="Produksi Sampah"
              subtitle="Produksi sampah/limbah"
              href="/lembaga/catat/produksi-sampah"
            />
          </div>
        </section>
        ...
        <div className="mt-6">
          <Button
            size="lg"
            fullWidth
            onClick={() => router.push("/lembaga/catat/riwayat")}
